...
- Ghostty and cmux Dashboard integration uses each application's native AppleScript API. CodexAgentTeam does not change cmux control-socket access settings.
