...
import { loadBuiltInAvatars } from "../plugins/codex-agent-team/scripts/lib/manager/avatars.mjs";
...
test("six built-in member avatars are bundled as usable image data", async () => {
  ...
  assert.ok(avatars.every((avatar) => avatar.labels.en && avatar.labels.zh));
});
